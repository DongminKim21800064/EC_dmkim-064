...
//1. GPIO Pin for TX and RX	
  ...
  //GPIO_pupd(GPIO_TX, pinTX, NONE);
	//GPIO_pupd(GPIO_RX, pinRX, NONE);
	
	GPIO_output(GPIO_TX, pinTX, PUSH_PULL, NONE, HIGH_SPEED);
	GPIO_output(GPIO_RX, pinRX, PUSH_PULL, NONE, HIGH_SPEED);
